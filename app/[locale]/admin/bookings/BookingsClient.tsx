      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
        <div>
          ...
          <h1 className="font-serif font-light text-night-600 text-3xl md:text-4xl leading-tight">
            ...
            <span className="ml-3 text-base text-night-300 font-light">({bookings.length})</span>
          </h1>
        </div>
        <button
          onClick={refresh}
          disabled={refreshing}
          className="inline-flex items-center gap-2 px-4 py-2.5 text-xs uppercase font-medium text-night-500 bg-cream-100 border border-bronze-100 hover:border-bronze-400 hover:text-bronze-500 transition-all rounded-md disabled:opacity-50"
