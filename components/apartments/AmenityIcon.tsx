...
const icons: Record<string, React.ReactNode> = {
  ...
  iron_and_ironing_board: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
      <path d="M 8 5 L 16 5" />
      <path d="M 9 5 L 9 8" />
      <path d="M 15 5 L 15 8" />
      <path d="M 4 14 L 20 14 L 18 10 L 10 8 L 7 8 L 4 12 Z" />
      <path d="M 2 18 L 22 18" />
      <path d="M 6 18 L 6 21" />
      <path d="M 18 18 L 18 21" />
    </svg>
  ),
};
...
export const AMENITIES_LIST: AmenityDef[] = [
  ...
  { key: 'massage_room',    label_fr: 'Espace massage',     label_en: 'Massage area',     icon: icons.massage_room },
